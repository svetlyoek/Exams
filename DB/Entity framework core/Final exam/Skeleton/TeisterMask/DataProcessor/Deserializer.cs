    ...
    public class Deserializer
    {
        ...
        public static string ImportProjects(TeisterMaskContext context, string xmlString)
        {
            var xmlSerializer = new XmlSerializer(
                typeof(ImportProjectsTasksDto[]), new XmlRootAttribute("Projects"));
            var projectsDto = (ImportProjectsTasksDto[])xmlSerializer.Deserialize(new StringReader(xmlString));
