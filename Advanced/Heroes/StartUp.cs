namespace Heroes
{
    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            var heroStrength = repository.GetHeroWithHighestStrength(); // Hero with name Second Hero
            var heroAbility = repository.GetHeroWithHighestAbility(); // Hero with name Hero Name
            var heroIntelligence = repository.GetHeroWithHighestIntelligence(); // Hero with name Hero
